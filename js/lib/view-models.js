...
(function() {
  ...
  window.menu = [
    {
      id: "tv",
      icon: '<svg id="icon-tv" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 130 130"><g fill-rule="nonzero"><path d="M19 23v58.66h92V23H19zm3.68 3.666h84.64v51.327H22.68V26.666zm16.215 58.66a1.847 1.847 0 0 0-1.668 2.005 1.85 1.85 0 0 0 2.013 1.661h51.52a1.852 1.852 0 0 0 1.617-.91c.33-.572.33-1.274 0-1.847a1.852 1.852 0 0 0-1.617-.91H38.895z"/></g></svg>',
      text: "Television",
      path: "/television",
      active: true,
    },
    {
      id: "connectivity",
      icon: '<svg id="icon-connectivity" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 130 130"><g fill-rule="nonzero"><path d="M6.269 56.174c.014.08.036.16.058.233a1.864 1.864 0 0 0 1.86 1.454h56.867l-11.687 11.69a1.874 1.874 0 0 0-.523 1.745 1.849 1.849 0 0 0 1.308 1.454 1.869 1.869 0 0 0 1.89-.523l14.885-14.89L72.207 56l-1.28-1.338-14.885-14.889a1.886 1.886 0 0 0-2.675 0 1.887 1.887 0 0 0 0 2.676l11.687 11.69H8.188a1.86 1.86 0 0 0-1.919 2.036zM34.237 89.5H97.5v-67H34.237v18.611a1.872 1.872 0 0 0 .923 1.636 1.878 1.878 0 0 0 1.875 0c.582-.342.93-.967.923-1.636V26.222h55.82v59.556h-55.82v-14.89a1.872 1.872 0 0 0-.923-1.635 1.878 1.878 0 0 0-1.875 0c-.581.342-.93.967-.923 1.636V89.5z"/></g></svg>',
      text: "Connectivity",
      path: "/connectivity",
      active: true,
    },
    ...
    {
      id: "my-orders",
      icon: '<svg id="icon-shopping-cart-loaded" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 130 130"><g fill-rule="nonzero"><path d="M65 11c-9.504 0-17.175 7.657-17.175 17.143v3.428H34.246l-.161 1.5-6.87 60L27 95h76l-.215-1.929-6.87-60-.16-1.5h-13.58v-3.428C82.175 18.657 74.504 11 65 11zm0 3.429c7.672 0 13.74 6.057 13.74 13.714v3.428H51.26v-3.428c0-7.657 6.068-13.714 13.74-13.714zM37.359 35h10.466v3.91c-1.025.594-1.718 1.68-1.718 2.947a3.432 3.432 0 0 0 3.435 3.429 3.432 3.432 0 0 0 3.435-3.429c0-1.268-.692-2.353-1.717-2.946V35h27.48v3.91c-1.025.594-1.717 1.68-1.717 2.947a3.432 3.432 0 0 0 3.435 3.429 3.432 3.432 0 0 0 3.435-3.429c0-1.268-.693-2.353-1.718-2.946V35h10.466l6.495 56.571H30.864L37.36 35z"/></g></svg>',
      text: "My Orders",
      path: "/my-orders",
      active: false,
    },
    {
      id: "movies",
      icon: '<svg id="icon-movies" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 130 130"><g fill-rule="nonzero"><path d="M24 13v82h82V13H24zm3.905 3.905h7.81v5.857h-7.81v-5.857zm11.714 0h50.762v35.143H39.619V16.905zm54.667 0h7.81v5.857h-7.81v-5.857zm-66.381 9.762h7.81v5.857h-7.81v-5.857zm66.38 0h7.81v5.857h-7.81v-5.857zm-66.38 9.762h7.81v5.857h-7.81v-5.857zm66.38 0h7.81v5.857h-7.81v-5.857zm-66.38 9.761h7.81v5.858h-7.81V46.19zm66.38 0h7.81v5.858h-7.81V46.19zm-66.38 9.762h7.81v5.858h-7.81v-5.858zm11.714 0h50.762v35.143H39.619V55.952zm54.667 0h7.81v5.858h-7.81v-5.858zm-66.381 9.762h7.81v5.857h-7.81v-5.857zm66.38 0h7.81v5.857h-7.81v-5.857zm-66.38 9.762h7.81v5.857h-7.81v-5.857zm66.38 0h7.81v5.857h-7.81v-5.857zm-66.38 9.762h7.81v5.857h-7.81v-5.857zm66.38 0h7.81v5.857h-7.81v-5.857z"/></g></svg>',
      text: "Movies",
    ...
    {
      id: "messages",
      icon: '<svg id="icon-messages" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 130 130"><g fill-rule="nonzero"><path d="M22 24v62h86V24H22zm3.44 3.444h79.12v4.306c-.672.585-30.832 26.93-33.648 29.385l-.16.162C68.52 63.24 66.235 63.61 65 63.61c-1.23 0-3.52-.37-5.751-2.314-.639-.559-5.234-4.534-8.547-7.427A18229.66 18229.66 0 0 1 25.44 31.75v-4.306zm0 8.88c2.983 2.604 13.565 11.827 22.575 19.699L25.44 73.89V36.325zm79.12 0v37.567L81.985 56.023c9.01-7.872 19.592-17.095 22.575-19.698zM50.649 58.338c2.09 1.823 5.865 5.126 6.342 5.543l.054.054c2.91 2.503 6 3.122 7.955 3.122 1.969 0 5.086-.626 8.009-3.176.484-.417 4.286-3.7 6.396-5.543L104.56 78.25v4.306H25.44V78.25l25.209-19.913z"/></g></svg>',
      text: "Messages",
      path: "/messages",
      active: false,
    },
    ...
    {
      id: "check-bill",
      icon: '<svg id="icon-viewbill" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 130 130"><g fill-rule="nonzero"><path d="M31 15V96h68V15H31zm3.238 3.24h61.524v74.52H34.238V18.24zm11.333 14.58v3.24H84.43v-3.24H45.57zm0 22.68v3.24h6.477V55.5H45.57zm11.334 0v3.24h27.524V55.5H56.905zM45.57 65.22v3.24h6.477v-3.24H45.57zm11.334 0v3.24h27.524v-3.24H56.905zM45.57 74.94v3.24h6.477v-3.24H45.57zm11.334 0v3.24h27.524v-3.24H56.905z"/></g></svg>',
      text: "Check Bill",
      path: "/check-bill",
      active: false,
    },
